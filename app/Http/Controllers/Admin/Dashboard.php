    ...
    public function change_price(Request $request)
    {
        ...
        try {
            ...
            $msg = [
                ...
                'vip4_percentage.required'     => 'VIP4 is required',
            ...
            if ($validator->fails())
              ...
              \DB::table('plans')->where('id',1)->update(['profit'=>$request->vip1_percentage]);
              \DB::table('plans')->where('id',2)->update(['profit'=>$request->vip2_percentage]);
              \DB::table('plans')->where('id',3)->update(['profit'=>$request->vip3_percentage]);
              \DB::table('plans')->where('id',4)->update(['profit'=>$request->vip4_percentage]);
