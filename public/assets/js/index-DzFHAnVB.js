...
const re = {
    ...
    De = {
        ...
        setup(o) {
            ...
            return (i, r) => {
                const h = P("van-icon");
                return _(), g("div", re, [e("div", me, [e("div", fe, [e("div", ve, [e("div", _e, [e("div", he, s(i.$t("quantify.doc6")), 1), e("div", ye, s(v(d)(o.incomeInfo.totalIncomeAmount, 4)), 1)]), e("div", ge, [e("div", pe, s(i.$t("common.doc38")), 1), e("div", $e, s(v(d)(o.incomeInfo.todayTeamIncomeAmount, 4)), 1)]), e("div", we, [e("div", Ie, s(i.$t("common.doc39")), 1), e("div", Te, s(v(d)(o.incomeInfo.totalTeamIncomeAmount, 4)), 1)])])]), e("div", Se, [e("div", Ce, [e("div", ke, s(v(d)(o.info.totalBalance, 2)) + " / " + s(v(d)(o.info.todayCanBalance, 2)), 1), e("div", qe, s(i.$t("quantify.doc3")), 1)]), e("div", Le, [e("div", Ee, s(v(d)(o.info.todayIncome, 2)), 1), e("div", Ne, s(i.$t("quantify.doc4")), 1)]), e("div", Pe, [e("div", xe, s(o.info.remainingCount) + "/" + s(o.info.todayCanCount), 1), e("div", Me, s(i.$t("quantify.doc5")), 1)])])]), e("div", be, [e("div", Ve, s(i.$t("quantify.doc7")), 1), e("div", {
                    class: oe(["val", {
                        on: o.rate && Number(o.rate) > 0
                    }]),
                    onClick: r[0] || (r[0] = x => v(k).push("/cards?type=1"))
    ...
    Fe = {
        ...
        setup(o, {
            ...
            const {
                ...
                proxy: r
            } = j(), h = Z(), x = o, p = k, M = O(() => h.state.user.userData.totalRecharge), H = O(() => {
                var a;
                return ((a = h.state.user.userData.email) == null ? void 0 : a.length) > 0
            }), m = n([]);
            async function L() {
                const a = await d();
                a.code == 0 ? (u.value = a.data.hasExecute, m.value = a.data.textList) : (u.value = !1, r.$toast(a.message))
            }
            const u = n(!1),
                E = n(!1);
            async function b() {
                if (!H.value && Number(M.value) > 0) {
                ...
                a.code === 0 || a.code === 12001 ? (u.value = !0, L()) : (u.value = !1, r.$toast(a.message))
            }
            const $ = n(!1);
            async function w() {
                var f;
            ...
            return ne(() => x.localTimestamp, a => {
                ...
                w()
            }), (a, f) => (_(), g("div", Re, [J(e("div", {
                class: "start-btn",
                onClick: b
            }, s(a.$t("quantify.doc9")), 513), [
                [W, !u.value]
            ]), J(e("div", Qe, [e("div", Ae, s(a.$t("quantify.doc10")), 1), (_(!0), g(F, null, le(m.value, (N, R) => (_(), g("div", {
                class: "item",
                key: N.consoleTimestamp
            }, [o.localTimestamp >= N.consoleTimestamp * 1e3 || R === 0 ? (_(), g("p", Be, s(N.consoleText), 1)) : ue("", !0)]))), 128))], 512), [
                [W, u.value]
            ])]))
        }
    },
        ...
        setup(o) {
            ...
            function N() {
                a.value = p.$common.getServerTime().getTime(), f.value = new Date().getTime(), window.serviceTimer && clearInterval(window.serviceTimer), window.serviceTimer = setInterval(() => {
                    a.value = a.value + 1e3, f.value = f.value + 1e3, w.value = R(a.value)
                }, 1e3)
            }
            ...
            function R(t) {
                ...
                let I = c.getMonth() + 1,
                    ...
                    l = c.getMinutes(),
                    y = c.getSeconds();
                return I < 10 && (I = `0${I}`), T < 10 && (T = `0${T}`), S < 10 && (S = `0${S}`), l < 10 && (l = `0${l}`), y < 10 && (y = `0${y}`), `${I}-${T}-${B} ${S}:${l}:${y}`
            }
            const V = n({}),
                Q = n(!1),
            ...
            async function te() {
                ...
                t.code == 0 ? t.data.list.length > 0 && (V.value = t.data.list[0], Q.value = !0, h.commit("SET_SITE_MSG_POPUP_LOCK", !0)) : p.$toast(t.message)
            }
            const A = n(!1);
            async function z() {
                await Promise.all([te(), N(), L(), E(), $(), H()]).finally(() => {
                    A.value = !1
                })
            }
            ...
            return (t, c) => {
                ...
                return _(), de(S, {
                    ...
                    popop: D(() => {
                        ...
                        return [C(T, {
                            show: Q.value,
                            "onUpdate:show": c[1] || (c[1] = se => Q.value = se),
                    ...
                    default: D(() => {
                        var l;
                        return [e("div", Ue, [e("div", je, [e("div", ze, s(t.$t("title.doc1")), 1), C(He, {
                            info: m.value,
                            incomeInfo: u.value,
                            time: w.value,
