                    ...
                    <div
                        ...
                        <div class="w-full mt-10 flex justify-center text-primary">
                            <div class="max-w-[1920px] w-full">
                                <div
                                    class="w-full relative max-w-[669px] pb-[46px] text-center pt-[36px] 
                                     rounded-[16px] mx-auto mt-[100px]" style="background: #28283;">
                                    <div class="w-[100px] h-[100px] rounded-full mx-auto text-[72px] font-semibold"
                                        style="background: #f1c40f; font-family: ClashDisplay-Semibold;">
                                    </div>
