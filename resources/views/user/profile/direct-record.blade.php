...
<body class="main_en">
            ...
            <div data-v-cfc9a7fc="" class="headers">
                <div data-v-397da544="" data-v-6df100a6="" class="head" data-v-cfc9a7fc="">
                    <div data-v-397da544="" class="container flex">
                        ...
                        <!---->
                        <!---->
                        <div data-v-397da544="" class="head_right">@lang('Direct Income Details')</div>
                    </div>
                </div>
            </div>
    ...
    <div class="invest">
        <div>
            ...
            <span class="content">$ <?php echo number_format($totalLvl,2) ?></span>
        </div>
        <div>
            <span>Today Earnings:</span>
            <span class="content">$ <?php echo number_format($todaysLvl,2) ?></span>
        </div>
    </div>
...
@foreach($team_record as $trecord)
    <div class="history">
        <!-- <div class="header">
            Team income
        ...
        <div class="item">
            ...
            <span class="value">{{$trecord->rname}} </span>
        </div>
      
        <div class="item">
            <span class="label">Direct Income</span>
            <span class="value">$ {{$trecord->comm}}</span>
        </div>
        <div class="item">
            <span class="label">Subscription</span>
            <span class="value"><?php if($trecord->amt==1){echo "Core Server";}elseif ($trecord->amt==4) {echo "Core Prime";}elseif ($trecord->amt==20) {echo "Core Plus";}elseif ($trecord->amt==40) {echo "Core Max";}elseif ($trecord->amt==120) {echo "Core Pro";}elseif ($trecord->amt==200) {echo "Core Hub";}elseif ($trecord->amt==500) {echo "Core Turbo";}else {echo "Member";}?></span>
        </div>
        
        <div class="item">
            <span class="label">Issuing Time</span>
            <span class="value">{{$trecord->created_at}}</span>
        </div>
    </div>
    @endforeach
