            ...
            <div data-v-cfc9a7fc="" class="headers">
                <div data-v-397da544="" data-v-9d2ee7be="" class="head" data-v-cfc9a7fc="">
                    <div data-v-397da544="" class="container flex">
                        <div data-v-397da544="" class="back"><a href="{{route('user.dashboard')}}" style="color:#fff;"><i
                        ...
                        <form method="post" action="{{ route('user.change-trxpasswword') }}">
                            ...
                            <div data-v-9d2ee7be="" data-v-cfc9a7fc="" class="item">
                                ...
                                <div data-v-9d2ee7be="" data-v-cfc9a7fc="" class="val">            
                                    <input data-v-f8e71db0="" class="inp" type="email" name="email" readonly="" style="width: 100%;"  value="{{Auth::user()->email}}">
                                </div>
                            </div>
                            ...
                            <div data-v-9d2ee7be="" data-v-cfc9a7fc="" class="item">
                                ...
                                <div data-v-9d2ee7be="" data-v-cfc9a7fc="" class="val"><input data-v-9d2ee7be=""
                                        ...
                                        name="password"> <i id="check" onclick="togglePasswordVisibility()" class="fa fa-eye-slash" style="float: right;
    margin-top: -15px;
    margin-right: -10px;"></i>
                                        </div>
                            ...
                            <div data-v-9d2ee7be="" data-v-cfc9a7fc="" class="item">
                                ...
                                <div data-v-9d2ee7be="" data-v-cfc9a7fc="" class="val inp"><input data-v-9d2ee7be=""
                                        ...
                                        placeholder="Enter the password again to confirm" id="passwordInput2" name="password_confirmation">
                                         <i id="check" onclick="togglePasswordVisibility2()" class="fa fa-eye-slash" style="float: right;
    margin-top: -15px;
    margin-right: -10px;"></i>
                                </div>
                            </div>
