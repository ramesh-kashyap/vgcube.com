...
<div
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-3 gap-6">
                            <div class="lg:col-span-3 xl:col-span-2 flex flex-col">
                               ...
                               <center>     <h3 class="font-semibold mb-3">@lang('  Change Transaction Password')</h3></center>
  ...
  <span 
    ...
    @lang('Get Code')
                                      ...
                                      <div class="mb-4">
                                        <label for="amount" class="block text-gray-700 font-medium mb-2">@lang('Transaction password')</label>
                                      
                                        <input data-v-9d2ee7be=""
                                        data-v-cfc9a7fc="" type="password" id="passwordInput" placeholder="Please enter the new password"
                                        name="password" class="w-full px-3 py-2 border border-gray-300 rounded-[12px]">
                              


                                      </div>
                                      <div class="mb-4">
                                        <label for="amount" class="block text-gray-700 font-medium mb-2">@lang('Confirm password')</label>
                                        <input data-v-9d2ee7be=""
                                        data-v-cfc9a7fc="" type="password"
                                        placeholder="Enter the password again to confirm" id="passwordInput2" name="password_confirmation" class="w-full px-3 py-2 border border-gray-300 rounded-[12px]">
                                      ...
                                      <div class="text-right">
                                        ...
                                        class="w-full h-[46px] px-4 py-2 rounded-[30px] bg-gray-300" styel>
                                        Confirm
                                        </button>
</br>
</br>
