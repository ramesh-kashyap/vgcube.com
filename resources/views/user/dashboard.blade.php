<html lang="en" style="">
   ...
   <body>
         ...
         <div class="w-full h-screen  flex justify-center">
            <div class="w-full max-w-[1920px] flex bg-white shadow-lg">
               <div style="background:rgb(37 35 30);"
                  ...
                  <div>
                     ...
                     <nav class="my-5 px-5 text-sm font-medium text-[#555]">
                        <div class="text-gray-400 text-xs mb-2">MENU</div>
                        <a
                  ...
                  <footer class="my-5 px-5 text-sm font-medium text-[#555] hidden md:block">
                     <div class="text-gray-400 text-xs mb-2">FOLLOW US</div>
                     <a
               ...
               <div style="background:rgb(37 35 30);" class="flex-1 flex flex-col  text-black bg-[#F1F1F1] h-screen">
                  <div class="flex items-center justify-between py-2 mt-5 px-4 md:px-10 lg:px-10 xl:px-20">
                     <a
                     ...
                     <div class="w-full flex flex-row justify-end md:justify-between">
                        <div class="flex items-center h-[38px] text-gray-800 font-medium">
                           <a
                        ...
                        <div class="relative flex items-center space-x-2 font-semibold">
                           <span
            ...
            <!-- footer navigation-->
            <div class="fixed bottom-0 w-full bg-white flex md:hidden justify-around shadow-lg" style="background: #f1c40f;">
               <a
      ...
      <script src="https://www.googletagmanager.com/gtag/js?id=G-5PPR32GMM8" id="_next-ga" data-nscript="afterInteractive"></script>
      ...
      <script src="{{ asset('') }}upnl/_next/static/chunks/pages/wallet/deposit-1ee2cf425e02648e.js"></script><span id="PING_IFRAME_FORM_DETECTION" style="display: none;"></span>
   </body>
</html>