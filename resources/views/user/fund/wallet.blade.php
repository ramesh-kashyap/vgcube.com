                                ...
                                <div class="bg-white rounded-[16px] p-6 lg:p-8">
                                    ...
                                    <div class="flex flex-col ">
                                        ...
                                        <div class="flex flex-row gap-2 items-end"><a
                                                ...
                                                fdprocessedid="scd5lj">Withdraw</button></a><a href="{{route('user.fund')}}"><button
                                                ...
                                                fdprocessedid="scd5lj" >Add Fund</button></a></div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr class="border-t h-[72px]">
                                                <td class="py-4 flex items-center space-x-2 lg:space-x-3 text-sm"><img
                                                        ...
                                                        src="./assets/icons/logo_point_2.svg"
                                            ...
                                            <tr class="border-t h-[72px]">
                                                <td class="py-4 flex items-center space-x-2 lg:space-x-3 text-sm"><img
                                                        ...
                                                        decoding="async" data-nimg="1"
                                                        src="./assets/icons/logo_mcc_2.svg"
                                            ...
                                            <tr class="border-t h-[72px]">
                                                <td class="py-4 flex items-center space-x-2 lg:space-x-3 text-sm"><img
                                                        ...
                                                        decoding="async" data-nimg="1"
                                                        src="./assets/icons/logo_btc_2.svg"
                                            ...
                                            <tr class="border-t h-[72px]">
                                                <td class="py-4 flex items-center space-x-2 lg:space-x-3 text-sm"><img
                                                        ...
                                                        decoding="async" data-nimg="1"
                                                        src="./assets/icons/logo_usdt_2.svg"
                                            ...
                                            <tr class="border-t h-[72px]">
                                                <td class="py-4 flex items-center space-x-2 lg:space-x-3 text-sm"><img
                                                        ...
                                                        decoding="async" data-nimg="1"
                                                        src="./assets/icons/logo_bnb_2.svg"
