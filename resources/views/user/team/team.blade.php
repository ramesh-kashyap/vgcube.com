...
image_2025_01_24T08_48_53_087Z.png" style="color: transparent; width:60px;"></a>
 ...
 <div
   class="flex-1 overflow-y-auto px-4 md:px-10 lg:px-10 xl:px-20 pt-5 pb-[88px] md:pb-[20px] " style="background: #272723;">
   <div class="w-full mt-10 flex justify-center text-primary">
      <div class="w-full max-w-[1440px] rounded-lg">
         <div class="max-w-[1920px] w-full grid grid-cols-1 md:grid-cols-3 gap-6" >
            ...
            <div class="bg-white p-5 h-full h- rounded-[16px] flex flex-col justify-between">
               <div>
                  <div class="flex justify-between items-center mb-[14px]">
                     <h3 class="text-[20px] font-medium text-primary">Referrals</h3>
                     <button
                        class="text-sm flex items-center h-[32px] px-4 py-1 rounded-[22px] bg-[#F1F1F1]">
                        <img
               ...
               <button
                  ...
                  <p class="mr-3" id="textToCopy">refferal link</p>
                  <img alt="Filter Icon" loading="lazy" width="16" id="copyIcon"
                     onclick="copyToClipboard()"
                     height="16" decoding="async" data-nimg="1"
                     src="{{ asset('') }}upnl/assets/icons/copy_clipboard.svg" style="color: transparent;">
               </button>
               <button class="mt-1  font-medium" style="color:#f1c40f;">Copy referral link</button>
            </div>
         </div>
