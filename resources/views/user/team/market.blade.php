                    ...
                    <div
                        ...
                        <div class="w-full mt-10 flex justify-center text-primary">
                            <div class="w-full max-w-[1440px] rounded-lg">
                                <div class="flex justify-between mb-4 items-center"><a href="{{route('user.strategy')}}"><button
                                        class="px-3 flex items-center h-[34px] bg-[#171717] rounded-[22px] text-[14px] text-white"
                                        fdprocessedid="ep7vm7"><img alt="Add Node Icon" loading="lazy" width="16"
                                            height="16" decoding="async" data-nimg="1" class="mr-1"
                                            src="{{ asset('') }}upnl/assets/icons/add_node.svg" style="color: transparent;">New
                                        Node</button></a>
                                ...
                                <div class="bg-white mb-3 p-4 rounded-[16px] font-semibold text-gray-600 text-center">
                                    <div class="hidden md:grid grid-cols-5 lg:grid-cols-6">
                                        <div class="text-left">Node</div>
                                        <div class="hidden lg:inline-block">Unique ID</div>
                                        <div>Status</div>
                                        <div>Hash Rate</div>
                                        <div>Total Uptime</div>
                                        <div class="text-right">Today Rewards</div>
                                    </div>
                                ...
                                <div class="space-y-4">
                                    <div
                                        ...
                                        <div class="hidden md:grid grid-cols-5 lg:grid-cols-6 items-center">
                                            ...
                                            <p class="hidden lg:block text-sm text-center font-medium">1236796590</p>
                                            <div class="flex justify-center"><span
                                                    class="flex px-[6px] py-1 rounded-full text-xs bg-[#C4FFC8]">
                                                   Online</span></div>
                                            <div class="flex justify-center">
                                                <p class="text-sm w-fit text-center px-3">0.25 TH/s</p>
                                            </div>
                                            <div class="flex justify-center">
