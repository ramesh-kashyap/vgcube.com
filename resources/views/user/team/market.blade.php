...
.van-slider {
    ...
    cursor: pointer;
                        ...
                        <div data-v-167ffb9b="" data-v-cfc9a7fc="" class="orderList" style="display: block;" id="orderList">
                            ...
                            $date21 = strtotime($investment->last_trade);
                            $date1 = strtotime(' + 24 hours', $date21);
                            $new_date1 = date('Y-m-d H:i:s', $date1);
                            
                           $date12 = strtotime(' + 1 hours', $date21);
                            $new_date1hour = date('Y-m-d H:i:s', $date12);
                            ...
                            document.addEventListener("DOMContentLoaded", function() {
                                // Set an interval to update countdown timers every second
                                setInterval(function() {
                                       @if($button == 2)
                                       countdownTimeStart("<?php echo $new_date1hour; ?>", 'timer-1h-{{$investment->id}}', 'progress-bar-1h-{{$investment->id}}',3600);
                                       @else
                                         countdownTimeStart("<?php echo $new_date1; ?>",'timer-24h-{{$investment->id}}', 'progress-bar-24h-{{$investment->id}}',86400);
                                         
                                        @endif
                                }, 1000);
                            });
                    
                            function countdownTimeStart(countDownDateStr,timerId, progressBarId,totalSeconds) {
                                ...
                                if (totalSeconds === 86400) {
                                    timerElement.textContent = `Next Task: ${hours}:${minutes < 10 ? '0' : ''}${minutes}:${seconds < 10 ? '0' : ''}${seconds}`;
                                } else {
                                    timerElement.textContent = `Reward Credit: ${hours}:${minutes < 10 ? '0' : ''}${minutes}:${seconds < 10 ? '0' : ''}${seconds}`;
                                }
                                ...
                                if (distance < 0) {
                                    clearInterval(timer);
                                    document.querySelector(`.js-countdown[data-id='${investmentId}']`).innerHTML = "EXPIRED";
                                }
                            }
                        </script>
                                ...
                                <div data-v-1fa86597="" data-v-cfc9a7fc="" class="buySeting" style="background:none">
                                    ...
                                    <ul data-v-1fa86597="" data-v-cfc9a7fc="" class="com-1">
                                        ...
                                        <!--</li>-->
                                         <li data-v-1fa86597="" data-v-cfc9a7fc="">
                                            ...
                                            <div data-v-1fa86597="" data-v-cfc9a7fc="" class="s">{{ $remaining_days > 0 ? $remaining_days : 0 }} @lang('Days')</div>
                                        </li>
                                        <!-- <li data-v-1fa86597="" data-v-cfc9a7fc="">
                                    ...
                                    <div data-v-1fa86597="" data-v-cfc9a7fc="" class="Progress">
                                        <div data-v-1fa86597="" data-v-cfc9a7fc="" class="cons">
                                            <div data-v-1fa86597="" class="van-slider" data-v-cfc9a7fc="" style="height: 35px;">
