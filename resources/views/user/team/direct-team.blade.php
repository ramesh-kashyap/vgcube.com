...
<head>
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/FloatingBubble-CGxu3QJe.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/ComImage-DYXlRKis.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/ComSticky-BzIdbyp2.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/icon_tips-BV3W61Vo.js">
...
<style>
    ...
    .list .item .item-bot[data-v-74600836] {
    padding: .18rem;
    border-radius: .32rem;
...
<body class="">
    <div id="app" data-v-app="">
        ...
        <div data-v-e85f0186="" data-v-6ebc7169="" class="page" style="background-color: rgb(255, 255, 255);">
            <div data-v-e85f0186="" class="headers">
                <div data-v-54adc729="" data-v-e85f0186="" class="inside-header">
                    <div data-v-54adc729="" class="left">
                        <div data-v-54adc729="" class="back"> <a href="{{route('user.level-team')}}"> <img data-v-54adc729=""
                ...
                <div data-v-e85f0186="" class="scroll">
                    <div data-v-6ebc7169="" style="">
                        <div class="van-sticky" style="">
                            <div data-v-6ebc7169="" class="tabs-con container">
                                <div data-v-6ebc7169="" class="title_heand">@lang('Team List')</div>
                                <div data-v-6ebc7169="" class="van-tabs van-tabs--line">
                                    <div class="van-tabs__wrap">
                                        <div role="tablist"
                                            class="van-tabs__nav van-tabs__nav--line van-tabs__nav--complete"
                                            aria-orientation="horizontal"
                                            style="border-color: rgb(219, 156, 0); background: none;">
                                            <!---->
                                            ...
                                            tabindex="0" aria-selected="true" aria-controls="van-tab-2">  <a style="color: <?php echo  (Session::get('selected_level')==$l)?"#fff":"#000"?>" href="{{route('user.referral-team') }}?selected_level={{$l}}" ><span
                                                class="van-tab__text">@lang('Level') {{$l}}</span> </a></div>
                    ...
                    <div data-v-24f31d9d="" data-v-6ebc7169="" class="van-pull-refresh van-refresh-com container">
                        <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                            <div class="van-pull-refresh__head" style="height: auto"></div>
                            <div data-v-24f31d9d="" role="feed" class="van-list" aria-busy="false">
                                <div data-v-74600836="" data-v-6ebc7169="" class="list">
                                        ...
                                        <div data-v-74600836="" class="item-bot">
                                            <div data-v-74600836="" class="item-child">
                                                <div data-v-74600836="" class="name">@lang('Deposit')</div>
                                                <div data-v-74600836="" class="val">{{ ($value->investment->sum('amount'))?$value->investment->sum('amount'):0 }} USDT</div>
                                            </div>
                                            <div data-v-74600836="" class="item-child">
                                                <div data-v-74600836="" class="name">@lang('Username')</div>
                                                <div data-v-74600836="" class="val">{{ $value->username }}
                                                </div>
                                            </div>
                                            
                                            <div data-v-74600836="" class="item-child">
                                                <div data-v-74600836="" class="name">@lang('Status')</div>
                                                <div data-v-74600836="" class="val"><span
                                      ...
                                      {{ $direct_team->withQueryString()->links() }}
                                       ...
                                       <div style="margin-bottom: 30em;"> <br><br><br><br><br><br><br></div>
                                </div>
                                <!---->
            ...
            <div role="dialog" tabindex="0" class="van-popup van-popup--bottom"
                ...
                <div class="van-picker">
                    <div class="van-picker__toolbar"><button type="button"
                        ...
                        <!----><button type="button"
                            class="van-picker__confirm van-haptics-feedback">Confirm</button>
                    </div>
                    <!---->
                    <!---->
            ...
            <div class="van-overlay" role="button" tabindex="0" style="z-index: 2006; display: none;">
                <!---->
            </div>
            <div role="dialog" tabindex="0" class="van-popup van-popup--bottom"
