                        ...
                        <div class="w-full mt-10 flex justify-center text-primary">
                            <div class="max-w-[1920px] w-full">
                                <div
                                    ...
                                    <div class="flex mx-auto w-full justify-center"><button
                                            class="rounded-[30px] h-[48px] py-3 px-6 bg-[#F1F1F1] mr-2"
                                            fdprocessedid="sf3iu" id="show">Change Password</button></div>
                                            <div class="flex mx-auto w-full justify-center"><button
                                            class="rounded-[30px] h-[48px] py-3 px-6 bg-[#F1F1F1] mr-2"
                            ...
                            <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50"
                                ...
                                <div class="bg-white rounded-[20px] w-[400px] px-8 pt-10 pb-6 text-center relative">
                                    ...
                                    <div class="mb-4 mt-8 text-left"><label class="block text-gray-600 mb-1">Current
                                            Password</label><input type="password"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-[12px]"
                                            placeholder="Enter Current Password" value=""></div>
                                    <div class="mb-4 mt-8 text-left"><label class="block text-gray-600 mb-1">New
                                            Password</label><input type="password"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-[12px]"
                                            placeholder="Enter New Password" value=""></div>
                                    <div class="mb-4 mt-4 text-left"><label class="block text-gray-600 mb-1">Repeat New
                                            Password</label><input type="password"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-[12px]"
                                            placeholder="Repeat New Password" value=""></div>
                                    <div class="mt-10"><button
                                            class="w-full h-[46px] mb-2 px-4 py-2 rounded-[30px] bg-black text-white">Confirm</button><button
                            ...
                            <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50"
                                ...
                                <div class="bg-white rounded-[20px] w-[400px] px-8 pt-10 pb-6 text-center relative">
                                    <h2 class="text-lg font-semibold">Change Transaction Password</h2>
                                    <div class="mb-4 mt-8 text-left"><label class="block text-gray-600 mb-1">Current
                                            Password</label><input type="password"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-[12px]"
                                            placeholder="Enter Current Password" value=""></div>
