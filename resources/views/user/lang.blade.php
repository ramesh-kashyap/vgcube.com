...
<head>
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/ComBtn-CB5ONs6P.js">
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/index-R9Sdxwdc.js">
    <link rel="modulepreload" as="script" crossorigin=""
    ...
    <link rel="modulepreload" as="script" crossorigin=""
        href="{{ asset('') }}assets/js/index-BOpasher.js">
    <link rel="modulepreload" as="script" crossorigin=""
            ...
            <div data-v-e85f0186="" class="headers">
                <div data-v-54adc729="" data-v-e85f0186="" class="inside-header">
                    <div data-v-54adc729="" class="left">
                        <div data-v-54adc729="" class="back"> <a
                                href="{{ route('user.profile') }}"><img data-v-54adc729=""
                                ...
                                <div data-v-211556f9="" role="feed" class="van-list" aria-busy="false">
                                    <div data-v-211556f9="" class="van-radio-group" role="radiogroup">
                                        ...
                                        @foreach($language as $item)
                                            ...
                                            <div data-v-211556f9="" class="item langSel"
                                                data-response="{{ $item->code }}">
                                                        ...
                                                        @if(session('lang') == $item->code)  
                                                            ...
                                                            <div
                                                                ...
                                                                <i class="van-badge__wrapper van-icon van-icon-success"
                                                                    style="border-color: rgb(133 74 246); background-color: rgb(133 74 246);">
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                                </i>
