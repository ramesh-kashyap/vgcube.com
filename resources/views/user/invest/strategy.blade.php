...
"><button data-v-167ffb9b=""
                 ...
                 -->
                      ...
                      <!-- <div data-v-167ffb9b="" data-v-cfc9a7fc="" class="totalBox" style="border-radius: 4%;border: #55b2c2 2px solid; padding-top='10px'">
                        ...
                        <div id="tab1" class="tab" style="color: #fff;"></div>
                        <div id="tab2" class="tab" style="color: grey;"></div>
                            ...
                            <div data-v-1fa86597="" data-v-cfc9a7fc="" class="container">
                                <div data-v-cc3ce6d2="" data-v-1fa86597="" class="levelBox" data-v-cfc9a7fc=""><img
                                    ...
                                    <div data-v-cc3ce6d2="" class="levelBox-head">
                                        <?php 
                            $plan = \DB::table('investments')->where('user_id',Auth::user()->id)->where('status','Active')->orderBy('id','DESC')->limit(1)->first();
                            $plan = $plan?$plan->plan:0;     
                           ?>
                                        <div data-v-cc3ce6d2="" class="left"><?php if($plan==1){echo "Core";}elseif ($plan==2) {echo "Core Prime";}elseif ($plan==3) {echo "Core Plus";}elseif ($plan==4) {echo "Core Max";}elseif ($plan==5) {echo "Core Pro";}elseif ($plan==6) {echo "Core Hub";}elseif ($plan==7) {echo "Core Turbo";}else {echo "Member";}?></div>
                                ...
                                <div data-v-1fa86597="" data-v-cfc9a7fc="" class="buySeting" style="background:none">
                                    ...
                                    <ul data-v-1fa86597="" data-v-cfc9a7fc="" class="com-1">
                                        ...
                                        <li data-v-1fa86597="" data-v-cfc9a7fc="">
                                            <div data-v-1fa86597="" data-v-cfc9a7fc="" class="n">Estimated Node Power Yield</div>
                                            <div data-v-1fa86597="" data-v-cfc9a7fc="" class="s"> 
                                    ...
                                    <p style="font-weight:300; font-size:10px;color:gray">The Node power Subscription  needs to be clicked and run for 1 hour every day to obtain Yield. If you do not click on it, there will be no Yield on the day. After the operation is completed, the proceeds will be distributed to the  Assets balance.
                                    </p>
                                    @if($button == 1)
                                    <!-- Button to start the task -->
                                    <form method="post" name="add" action="{{ route('user.generate_roi',['invest_id' => 0]) }}" onsubmit="return validateForm()">
                                        {{ csrf_field() }}
                                    ...
                                    <div data-v-1fa86597="" data-v-cfc9a7fc="" class="Progress">
                                        <div data-v-1fa86597="" data-v-cfc9a7fc="" class="cons">
                                            <div data-v-1fa86597="" class="van-slider" data-v-cfc9a7fc="" style="height: 25px;">
                                                <div class="van-slider__bar" id="progress-bar-1h" style=" width: 0%;">
                                        ...
                                        <div class="times">
                                            <p id="timer-1h" class="timer">You will be Yield  in: 1:00:00</p>
                                        </div>
                                    </div>
                                @else
