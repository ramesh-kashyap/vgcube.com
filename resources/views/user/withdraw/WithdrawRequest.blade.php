...
<div
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-3 gap-6">
                            <div class="lg:col-span-3 xl:col-span-2 flex flex-col">
                             ...
                             <center>       <h3 class="font-semibold mb-3">Withdraw</h3></center>
</br></br>
                                    <form action="{{ route('user.Withdraw-Request') }}" method="POST">
                            {{ csrf_field() }}                                     <!-- Replace /submit-wallet with your form submission URL -->
                                      <div class="mb-4">
                                        <label for="amount" class="block text-gray-700 font-medium mb-2">Withdraw amount</label>
                                    ...
                                    id="walletAddress"  class="w-full px-3 py-2 border border-gray-300 rounded-[12px]">
                                      </div>

                                      <div class="mb-4">
                                        <label for="amount" class="block text-gray-700 font-medium mb-2">Wallet Address</label>
                                        <input data-v-7bab1ac4=""
                                        data-v-cfc9a7fc="" type="password"
                                        placeholder="Please enter the transaction password"
                                        name="transaction_password" id="passwordInput" class="w-full px-3 py-2 border border-gray-300 rounded-[12px]">
                                      ...
                                      <div class="text-right">
                                        <button type="submit" style="background-color: rgb(34 197 94);" class="w-full px-3 py-2 border border-gray-300 rounded-[12px]" hover:bg-blue-600" styel>
                                        Confirm
                                        </button>
                                      </div>
...
<p class="text-sm text-left text-secondary mt-4">Available Balance <a
                                       class="text-sm text-right text-secondary mt-4" style=" margin-left: 460px;">{{ number_format(Auth::user()->available_balance(), 2) }}
                                       USDT</a></p>
                                       <p class="text-sm text-left text-secondary mt-4">Arrived quantity <a
                                       class="text-sm text-right text-secondary mt-4" style=" margin-left: 476px;">0
                                       USDT</a></p>
                                       <p class="text-sm text-left text-secondary mt-4">Minimum Withdraw amount<a
                                       class="text-sm text-right text-secondary mt-4" style=" margin-left: 400px;">10 USDT</a></p>
                                       <p class="text-sm text-left text-secondary mt-4">Maximum Withdraw amount <a
                                       class="text-sm text-right text-secondary mt-4" style=" margin-left: 400px;">No Limit</a></p>
                                    </form>
                                  </div>
