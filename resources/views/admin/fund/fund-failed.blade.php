            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Failed Fund Report</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Failed Fund Report</h4>
                            </div>
                            <div class="card-body">

                                <div id="example_wrapper" class="dataTables_wrapper">
                                    <form action="{{ route('admin.fund-failed') }}" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{ route('admin.fund-failed') }}" style="padding: 0.6rem 2rem;"
                                                        name="reset"
                                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                                        value="Reset">Reset</a>
                                                </div>
