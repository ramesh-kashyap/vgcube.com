                                       ...
                                       <div class="mb-3 col-md-12">
                                           <label class="form-label">Enter Amount</label>
                                                    ...
                                                    <select required class="form-control"  name="amount" >
                                                        ...
                                                        <option value="300">{{currency()}} 300</option>
                                                        <option value="1200">{{currency()}} 1200</option>
                                                        <option value="3600">{{currency()}} 3600</option>
                                                        <option value="6000">{{currency()}} 6000</option>
                                                        <option value="15000">{{currency()}} 15000</option>
                                                    </select>
                                       </div>
