        ...
        <div class="min-h-screen flex flex-col items-center justify-center pt-[100px] bg-gray-50 p-6">
            ...
            <div class="bg-[#FFF] max-w-[385px] rounded-[20px] py-6 px-6 md:px-8 w-full"
                ...
                <h2 class="text-[28px] font-semibold text-gray-800 text-center mb-2"
                    style="font-family: ClashDisplay-Semibold;">Register</h2>
...
">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="mt-1 h-[48px] block w-full px-4 py-2 border border-gray-300 
                            rounded-[12px] shadow-sm focus:outline-none focus:ring focus:ring-green-500"
                            value="" name="email" id="emailId"
...
@php
                    ...
                    <div><label for="password" class="block text-sm font-medium text-gray-700">Referral Code</label>
                        <div class="relative">
                            
                        <input  name="sponsor" value="{{$sponsor?$sponsor:old('sponsor')}}" id="sponsor"
                                                type="text" placeholder="Invitation code cannot be empty"
                            class="mt-1 h-[48px] block w-full px-4 py-2 border border-gray-300 
                            rounded-[12px] shadow-sm focus:outline-none focus:ring focus:ring-green-500"
                            >
                    ...
                    <div><label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                        ...
                        <input
                                ...
                                placeholder="Password" type="password" class="mt-1 h-[48px] block w-full px-4 py-2 border border-gray-300
                                 rounded-[12px] shadow-sm focus:outline-none focus:ring focus:ring-green-500"
                                >
                    ...
                    <div><label for="password" class="block text-sm font-medium text-gray-700">Repeat Password</label>
                        <div class="relative">
                            
                        <input
                              value="{{old('password_confirmation')}}" name="password_confirmation" id="passwordInput2"
                    ...
                    <div><label for="password" class="block text-sm font-medium text-gray-700">Captcha Code</label>
                        <div class="relative">
...
>
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        fdprocessedid="zpoh7">Register</button>
