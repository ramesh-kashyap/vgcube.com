<html lang="en" style="">
   <head>
      ...
      <link rel="stylesheet" href="{{ asset('') }}upnl/_next/static/css/c9d1efbde5d75517.css" data-n-g="">
   ...
   <body>
            ...
            <div class="bg-[#FFF] max-w-[385px] rounded-[20px] py-6 px-6 md:px-8 w-full"
               ...
               <form action="{{route('login')}}" method="POST" id="form-id" class="space-y-6" data-gtm-form-interact-id="0">
                  ...
                  <div class="input-group mb-3">
                     ...
                     <input type="text" class="form-control" placeholder="Enter username" aria-label="Username" name="username" aria-describedby="basic-addon1" style="
                        height: 38px;
                        width: 70%;
                        border-radius: 12px;
                        border-color: grey;
                  ...
                  <div data-v-a84105cc="" class="van-popup van-popup--round van-popup--bottom"
                     ...
                     <div data-v-a84105cc="" class="area_pop">
                        <div data-v-a84105cc="" class="title rel">
                           Choose the international area
                           code 
                           <div data-v-a84105cc="" class="abs">
                              <i data-v-a84105cc="" id="cancel"
                        ...
                        <div data-v-a84105cc="" class="so db">
                           ...
                           <div data-v-a84105cc="" class="flexs">
                              <input data-v-a84105cc=""
      ...
      <next-route-announcer>
         <p aria-live="assertive" id="__next-route-announcer__" role="alert"
            ...
            MeshChain - Decentralized Compute Network for AI Training, Inference, and Gaming Rendering
         </p>
      </next-route-announcer>
