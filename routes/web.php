...
Route::get('/releaseIncome', [App\Http\Controllers\Cron::class, 'releaseIncome'])->name('releaseIncome');
...
Route::any('/registers', [App\Http\Controllers\Register::class, 'register'])->name('registers');
Route::any('/confirm', [App\Http\Controllers\Register::class, 'confirm'])->name('confirm');
...
Route::get('/privacy', [App\Http\Controllers\FrontController::class, 'termcandition'])->name('privacy');
...
Route::get('/direct-record', [App\Http\Controllers\UserPanel\Profile::class, 'direct_record'])->name('user.direct-record');
...
Route::post('/generate_roi/{invest_id}', [App\Http\Controllers\UserPanel\Invest::class, 'generate_roi'])->name('user.generate_roi');
...
//pln
Route::get('/package', [App\Http\Controllers\UserPanel\pla::class, 'package'])->name('user.package');
//pln
// withdraw
...
Route::get('/account', [App\Http\Controllers\UserPanel\Team::class, 'leftteam'])->name('user.account');
// Route::get('/ai-chat', [App\Http\Controllers\UserPanel\Team::class, 'rightteam'])->name('user.Market');
Route::get('/node-power', [App\Http\Controllers\UserPanel\Invest::class, 'nodepower'])->name('user.Market');
...
Route::post('/save-hit-count', [App\Http\Controllers\UserPanel\Profile::class, 'saveHitCount'])->name('user.save-hit-count');
...
//fundController
 ...
 Route::get('fund-failed', [App\Http\Controllers\Admin\FundController::class, 'fund_failed'])->name('admin.fund-failed');
