...
})(Object.create(null)), A = e => (e = e.toLowerCase(), t => H(t) === e), I = e => t => typeof t === e, {
    isArray: C
} = Array, _ = I("undefined");
...
const ve = (e, t, n, {
    ...
    nt = (e => t => e && t instanceof e)(typeof Uint8Array < "u" && Z(Uint8Array)),
    rt = (e, t) => {
    ...
    it = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function (n, r, s) {
...
function M(e, t, n) {
    ...
    function l(f, d, w) {
        ...
        if (f && !w && typeof f == "object") {
            ...
            else if (a.isArray(f) && wt(f) || (a.isFileList(f) || a.endsWith(d, "[]")) && (b = a.toArray(f))) return d = ge(d), b.forEach(function (x, ke) {
                !(a.isUndefined(x) || x === null) && t.append(i === !0 ? ie([d], ke, o) : i === null ? d : d + "[]", h(x))
            }), !1
        }
...
const Pe = {
    ...
    gt = (e => Ce && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product),
...
const te = ee,
    Bt = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
    Dt = e => {
        const t = {};
        let n, r, s;
        return e && e.split(`
...
const zt = O.hasStandardBrowserEnv ? function () {
    ...
    Wt = Vt && function (e) {
        return new Promise(function (n, r) {
            ...
            if ("onloadend" in u ? u.onloadend = S : u.onreadystatechange = function () {
                    ...
                    e.timeoutErrorMessage && (w = e.timeoutErrorMessage), r(new m(w, b.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED, e, u)), u = null
    ...
    De = {
        getAdapter: e => {
            ...
            for (let o = 0; o < t; o++) {
                n = e[o];
                let i;
                if (r = n, !Kt(n) && (r = X[(i = String(n)).toLowerCase()], r === void 0)) throw new m(`Unknown adapter '${i}'`);
                if (r) break;
                s[i || "#" + o] = r
            }
            if (!r) {
